...
- **Подтверждение после пуша (2026-09-18): `qa:all` ок; бессмысленный текст → 200 + пустые правила; «угол ABC 30 градусов» → распознан корректно; ~5 s на запрос; эпизодические 503 (high demand на стороне Google — не наша проблема). Живой CORS-чек Gemini ЗАКРЫТ.**
