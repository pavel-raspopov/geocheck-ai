...
- The repo has no test runner **and** the current plan or project docs name how to verify (lint, build, manual click-through): do **not** add a test framework unasked. Follow those verify commands. User instructions and the written plan outrank the Iron Law.
